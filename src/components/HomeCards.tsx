    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          whileHover={{ 
            scale: 1.1,
            rotate: isCreate ? 10 : 0, // Changed rotation slightly for folder feel
            y: -5
          }}
          transition={{ duration: 0.4, ease: 'easeOut' }}
        >
  ...
  return (
    <>
      <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        <HomeCard
          title="JET Snippets"
          description="Browse and create data processing snippets for Spark, Python, and SQL transformations."
          icon={<Zap className="w-8 h-8 text-primary-foreground" />}
          gradient="gradient-jet"
          delay={0.1}
          onClick={() => navigate('/category/jet')}
