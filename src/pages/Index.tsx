...
const Index = () => {
  const {
    snippets,
    categories
  } = useSnippets(); // Get real data from context
  const [selectedTags, setSelectedTags] = useState<string[]>([]);
  ...
  return <div className="min-h-screen bg-background relative">
      ...
      {!searchQuery && <section className="pt-24 pb-16 px-4">
          <div className="container mx-auto text-center">
            <motion.div initial={{
          opacity: 0,
          y: 20
          ...
          duration: 0.6
              ...
              <motion.div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/5 rounded-full border border-primary/10 mb-6" initial={{
            scale: 0.9,
            opacity: 0
          }} animate={{
            scale: 1,
            ...
            delay: 0.2
              ...
              <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4">Find, Make & Share
Code Snippets<br />
                <span className="bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                  Code Snippets
                </span>
      ...
      {!searchQuery && <section className="py-8 px-4">
          <div className="container mx-auto">
            <HomeCards />
          </div>
        </section>}
        ...
        <div className="container mx-auto">
          ...
          duration: 0.5
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                {searchQuery ? `Found ${filteredSnippets.length} matches` : 'Browse recent and popular code solutions'}
              </p>
            </div>
            <div className="hidden md:flex items-center gap-2 text-muted-foreground">
              <Code2 className="w-5 h-5" />
          ...
          <div className="grid lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3">
              <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-4">
                {filteredSnippets.map((snippet, index) => <SnippetCard key={snippet.id} snippet={snippet} index={index} />)}
              </div>
              
              {filteredSnippets.length === 0 && <motion.div initial={{
              opacity: 0
            }} animate={{
              opacity: 1
